...
__decorate([
    typeorm_1.ManyToOne(() => Board_entity_1.default, (board) => board.tasks),
    __metadata("design:type", Board_entity_1.default)
], Task.prototype, "board", void 0);
__decorate([
    typeorm_1.ManyToOne(() => Column_entity_1.default, (column) => column.tasks),
    __metadata("design:type", Column_entity_1.default)
